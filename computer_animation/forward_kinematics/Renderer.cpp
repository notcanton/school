...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	static auto bone_x1_widget = gui_1->addVariable("X1", m_bone_animation->X1);
	static auto bone_y1_widget = gui_1->addVariable("Y1", m_bone_animation->Y1);
	static auto bone_z1_widget = gui_1->addVariable("Z1", m_bone_animation->Z1);
	static auto bone_x2_widget = gui_1->addVariable("X2", m_bone_animation->X2);
	static auto bone_y2_widget = gui_1->addVariable("Y2", m_bone_animation->Y2);
	static auto bone_z2_widget = gui_1->addVariable("Z2", m_bone_animation->Z2);
	static auto bone_x3_widget = gui_1->addVariable("X3", m_bone_animation->X3);
	static auto bone_y3_widget = gui_1->addVariable("Y3", m_bone_animation->Y3);
	static auto bone_z3_widget = gui_1->addVariable("Z3", m_bone_animation->Z3);
